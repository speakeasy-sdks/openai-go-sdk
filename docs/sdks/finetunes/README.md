...
func main() {
    ...
    res, err := s.FineTunes.CancelFineTune(ctx, operations.CancelFineTuneRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.FineTunes.ListFineTuneEvents(ctx, operations.ListFineTuneEventsRequest{
        FineTuneID: "ft-AF1WoRqd3aJAHsqc9NY7iL8F",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.FineTunes.RetrieveFineTune(ctx, operations.RetrieveFineTuneRequest{
        FineTuneID: "ft-AF1WoRqd3aJAHsqc9NY7iL8F",
    })
    if err != nil {
        log.Fatal(err)
